...
현재 개발 스냅샷은 **0.18.4 (versionCode 67)**이며 Samsung SM-F971N과 Android 17에서 개발하고 있습니다. 전체 화면 영상 전환, 패널별 회전, 화면 잠금 재개, 중지와 강제 종료 복구를 실기에서 확인했습니다. 0.18.4에서 추가한 전환 중 nit 메타데이터 유지는 자동 밝기 설정을 바꾸지 않는 것을 확인했으며 최종 접기·펼치기 체감 검증을 진행 중입니다.
